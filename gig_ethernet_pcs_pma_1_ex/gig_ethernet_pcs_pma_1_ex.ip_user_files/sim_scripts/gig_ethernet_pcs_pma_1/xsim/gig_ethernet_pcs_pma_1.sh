...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L gig_ethernet_pcs_pma_v16_2_12 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gig_ethernet_pcs_pma_1 xil_defaultlib.gig_ethernet_pcs_pma_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gig_ethernet_pcs_pma_1 -key {Behavioral:sim_1:Functional:gig_ethernet_pcs_pma_1} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/xilinx/Vivado/2023.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gig_ethernet_pcs_pma_1.wdb xsim.dir libdpi.so)
