...
#
# Script generated by Vivado on Thu Jul 31 11:28:49 JST 2025
# SW Build 3865809 on Sun May  7 15:04:56 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : gig_ethernet_pcs_pma_1.sh
...
#
# Usage        : gig_ethernet_pcs_pma_1.sh
#                gig_ethernet_pcs_pma_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gig_ethernet_pcs_pma_1.sh [-reset_run]
#                gig_ethernet_pcs_pma_1.sh [-reset_log]
#                gig_ethernet_pcs_pma_1.sh [-help]
#
...
#                script (type 'gig_ethernet_pcs_pma_1.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname gig_ethernet_pcs_pma_v16_2_12 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm gig_ethernet_pcs_pma_v16_2_12 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "gig_ethernet_pcs_pma_1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gig_ethernet_pcs_pma_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work gig_ethernet_pcs_pma_v16_2_12 -V93 $xmvhdl_opts \
  "../../../ipstatic/hdl/gig_ethernet_pcs_pma_v16_2_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvlog -work gig_ethernet_pcs_pma_v16_2_12 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.gig_ethernet_pcs_pma_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.gig_ethernet_pcs_pma_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log gig_ethernet_pcs_pma_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gig_ethernet_pcs_pma_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gig_ethernet_pcs_pma_1.sh [-help]\n\
Usage: gig_ethernet_pcs_pma_1.sh [-step]\n\
Usage: gig_ethernet_pcs_pma_1.sh [-lib_map_path]\n\
Usage: gig_ethernet_pcs_pma_1.sh [-reset_run]\n\
Usage: gig_ethernet_pcs_pma_1.sh [-reset_log]\n\
Usage: gig_ethernet_pcs_pma_1.sh [-keep_index]\n\
Usage: gig_ethernet_pcs_pma_1.sh [-noclean_files]\n\n\
