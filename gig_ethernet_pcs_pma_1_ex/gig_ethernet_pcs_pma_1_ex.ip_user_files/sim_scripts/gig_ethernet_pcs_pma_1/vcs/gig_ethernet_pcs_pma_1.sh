...
design_libs=(xpm gig_ethernet_pcs_pma_v16_2_12 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work gig_ethernet_pcs_pma_v16_2_12 $vhdlan_opts \
  "../../../ipstatic/hdl/gig_ethernet_pcs_pma_v16_2_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vlogan -work gig_ethernet_pcs_pma_v16_2_12 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.gig_ethernet_pcs_pma_1 xil_defaultlib.glbl -o gig_ethernet_pcs_pma_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./gig_ethernet_pcs_pma_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key gig_ethernet_pcs_pma_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc gig_ethernet_pcs_pma_1_simv.daidir vcs_lib c.obj)
